function [r,c] = harris_corner(img)
     %% Parameters
    gaussian_sigma = 8;          %gaussian sigma
    gaussian_window =8;
    thresh = 100000;      %used to cut off finding maxima
    ...
    for x=1:numOfRows
       for y=1:numOfColumns
            if H(x,y) > 0
                ...
                img = insertShape(img,'circle',[y x 1],'LineWidth',2,'color','green');
